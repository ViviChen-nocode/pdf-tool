...
const tools = [
  {
    ...
    tips: ["上傳需要修改上傳 PNG 圖片", "描述你想要的修改", "下載生成的新圖片"],
    videoId: "9FSH3hpS-MY",
  },
  {
    name: "Lovart.ai",
    ...
    tips: ["上傳需要修改上傳 PNG 圖片", "使用「編輯文字」功能修改文字內容", "匯出高畫質圖片"],
    videoId: "Kc__MyFjlQg",
  },
  {
    name: "Canva",
    ...
    tips: ["將上傳需要修改上傳 PNG 圖片", "使用魔法抓取需要的元素", "調整元素大小或移動"],
    videoId: "PbUlLJWeX6w",
  },
];
